...
{
    public class Vtrrcc04
    {
        public string Cjrmvi_Tipcpt { get; set; }
        public string Cjrmvi_Codcpt { get; set; }
        ...
        public decimal? Cjrmvi_Impuss { get; set; }
        public string Cjrmvi_Docfir { get; set; }
        public string Cjrmvi_Textos { get; set; }
        public string Cjrmvi_Tipdoc { get; set; }
        public string Cjrmvi_Nrodoc { get; set; }
        public string Cjrmvi_Comori { get; set; }
        public string Cjrmvi_Codori { get; set; }
        public string Usr_Cjrmvi_Ctacte { get; set; }
